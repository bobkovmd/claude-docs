...
Don't put your own instructions in tool results. Because Claude treats tool-result content as untrusted data, instructions you place there may be ignored or flagged as a potential injection. Send your instructions in a user turn that follows the tool_result block. On Claude Opus 4.8 and later, you can also use a mid-conversation system message.
...

If you're using the computer use tool, Anthropic runs additional classifiers that detect potential prompt injections in screenshots and steer Claude to ask for user confirmation before acting. See that page for details and opt-out information.

