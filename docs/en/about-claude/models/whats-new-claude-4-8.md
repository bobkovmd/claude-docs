...
](/docs/en/about-claude/models/migration-guide#migrating-from-claude-opus-47)[Effort
Control how many tokens Claude uses when responding with the effort parameter, trading off between response thoroughness and token efficiency.

](/docs/en/build-with-claude/effort)[Adaptive thinking
Let Claude dynamically determine when and how much to use extended thinking with adaptive thinking mode.

](/docs/en/build-with-claude/adaptive-thinking)[Prompt caching
How mid-conversation system messages preserve cache hits.

](/docs/en/build-with-claude/prompt-caching)[Stop reasons and fallback
...
](/docs/en/build-with-claude/handling-stop-reasons)[Fast mode (research preview)
